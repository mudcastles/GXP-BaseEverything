package com.peng.gxpbaseeverything.view.activity.mvp
...
import kotlinx.android.synthetic.main.mvp_gxp_activity_toolbar.*
import kotlinx.android.synthetic.main.mvvm_gxp_activity_toolbar.com_peng_baseeverthing_root_view


abstract class GXPToolbarActivity : GXPBaseActivity() {
    final override fun getRootLayoutId(): Int = R.layout.mvp_gxp_activity_toolbar
